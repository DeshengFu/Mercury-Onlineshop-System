...
{
	var arr = art.menu1(listID, ID, linkID, catalogID, showLevel, title, subTitle, name, subName, code, service, price, tax, state, weight, icon, sold, posEval, negEval, insertTime, updateTime, description, offer, inventory);
